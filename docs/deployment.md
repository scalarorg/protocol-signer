...
_Note_: We recommend creating multiple backups of the wallet and
...
[releases](https://github.com/scalarorg/protocol-signer/releases) page.

```shell
git clone https://github.com/scalarorg/protocol-signer.git
cd protocol-signer
...
The above command will build and install the `protocol-signer` binary to
...
found [here](https://github.com/scalarorg/networks/). The parameters will be
...
```shell
protocol-signer start --config /path/to/signer/home/config.toml \
